...
const Hero: React.FC = () => (
  <main className="relative z-10 flex flex-col items-center justify-center min-h-[60vh] px-4 pointer-events-none">
    ...
    <div className="w-full max-w-xl mb-8 pointer-events-auto">
      <input
        type="text"
    ...
    <div className="w-full max-w-xl flex justify-center gap-4 mb-4 pointer-events-auto">
